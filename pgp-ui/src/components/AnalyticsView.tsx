      ...
      <div className="glass-panel" style={{ padding: '36px', background: '#ffffff' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '32px' }}>
          ...
          <div style={{ background: '#f0fdf4', border: '1px solid rgba(16, 185, 129, 0.25)', borderRadius: '14px', padding: '20px' }}>
            ...
            <p style={{ fontSize: '1.5rem', fontWeight: '800', color: giveaway.winnerClaimed ? '#059669' : '#64748b', marginTop: '4px' }}>
        ...
        <h3 style={{ fontSize: '1.25rem', marginBottom: '12px', color: '#0f172a' }}>🌳 On-Chain Commitment Accumulator</h3>
