      ...
      >
        ...
        <div style={{ maxWidth: '720px', position: 'relative', zIndex: 10 }}>
          ...
          <p style={{ color: '#475569', fontSize: '1.05rem', marginBottom: '24px', lineHeight: '1.6' }}>
            Midnight Private Giveaway Platform leverages zk-SNARKs and Compact smart contracts to let organizers host
            verifiable giveaways while guaranteeing total participant privacy.
          </p>
