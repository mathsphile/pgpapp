...
export const GiveawayPortal: React.FC<GiveawayPortalProps> = ({
  giveaway, enterGiveawayAction, contractAddress, indexerConnected, setGiveaway,
}) => {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div className="glass-panel" style={{ padding: '36px', background: '#ffffff' }}>
        ...
        {!indexerConnected && (
          <div style={{ background: '#fef3c7', border: '1px solid #f59e0b', borderRadius: '12px', padding: '16px', marginBottom: '24px', fontSize: '0.9rem', color: '#78350f' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div style={{ background: '#ecfdf5', border: '1px solid rgba(16, 185, 129, 0.3)', borderRadius: '16px', padding: '24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '0.85rem' }}>
                ...
                <div>
                  ...
                  <input className="input-glass" readOnly value={`0x${generatedCommitment}`} style={{ marginTop: '4px', fontFamily: 'monospace', color: '#059669', fontWeight: '700' }} />
                </div>
              </div>
          ...
          <button
            ...
            style={{ width: '100%', justifyContent: 'center', marginTop: '12px', padding: '14px', opacity: generatedCommitment && indexerConnected ? 1 : 0.5 }}
